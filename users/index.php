...
$users = $conn->query("SELECT * FROM users ORDER BY role, nom")->fetchAll();
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div class="container-fluid px-4 py-4" style="max-width:900px">
  ...
  <div class="page-header">
    ...
    <a href="add.php" class="btn btn-success">+ Ajouter utilisateur</a>
  </div>
      ...
      <table class="table table-hover mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end">
              <a href="edit.php?id=<?= $u['id'] ?>" class="btn btn-sm btn-outline-primary">Modifier</a>

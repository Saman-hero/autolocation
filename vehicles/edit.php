...
<div class="container py-4" style="max-width:780px">
  <div class="page-header">
    <div>
      <div class="text-muted small mb-1"><a href="index.php" class="text-decoration-none text-muted">Véhicules</a> / Modifier</div>
        ...
        <div class="col-md-3">
          ...
          <select name="type_vidange" class="form-select">
            ...
            <?php foreach (['Huile moteur 10W-40','Huile moteur 5W-30','Huile diesel','Vidange complète'] as $tv): ?>
              <option <?= ($v['type_vidange'] ?? '') === $tv ? 'selected' : '' ?>><?= $tv ?></option>
            <?php endforeach; ?>
          </select>
        </div>
        <div class="col-md-3">

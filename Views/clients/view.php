...
<head>
  ...
  <title><?= htmlspecialchars($c['nom'] . ' ' . $c['prenom']) ?> — AutoLocation</title>
  ...
  <div class="page-header">
    <div>
      <div class="text-muted small mb-1">
        <a href="/location/public/index.php?url=clients" class="text-decoration-none text-muted">Clients</a> / Profil
      </div>
    ...
    <div class="d-flex gap-2">
      ...
      <a href="/location/public/index.php?url=clients/edit&id=<?= $id ?>" class="btn btn-primary">Modifier</a>
      <a href="/location/public/index.php?url=reservations/add&client_id=<?= $id ?>" class="btn btn-success">+ Nouvelle location</a>
    </div>
  </div>
      ...
      <div class="card mb-3">
        <div class="card-body text-center py-4">
          ...
          <span class="badge <?= $sBadge[$c['statut']] ?? 'bg-secondary' ?> fs-6 px-3 py-2">
            <?= $sLabel[$c['statut']] ?? htmlspecialchars($c['statut']) ?>
          </span>
    ...
    <div class="col-lg-8">
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a href="/location/public/index.php?url=reservations/add&client_id=<?= $id ?>" class="btn btn-sm btn-success">+ Nouvelle</a>
        </div>
          ...
          <div class="table-responsive">
            <table class="table table-hover mb-0">
              <thead class="table-light">
                <tr>
                  <th>Référence</th><th>Véhicule</th><th>Début</th><th>Fin prévue</th><th>Total</th><th>Statut</th><th></th>
                </tr>
              </thead>
              <tbody>
              <?php

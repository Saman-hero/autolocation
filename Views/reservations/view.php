...
<head>
  ...
  <title>Réservation <?= htmlspecialchars($r['reference']) ?> — AutoLocation</title>
  ...
  <div class="page-header">
    <div>
      <div class="text-muted small mb-1">
        <a href="/location/public/index.php?url=reservations" class="text-decoration-none text-muted">Réservations</a> / Détail
      </div>
    ...
    <div class="d-flex gap-2">
      ...
      <?php if (in_array($r['statut'], ['en attente','confirmée'])): ?>
        <a href="/location/public/index.php?url=reservations/edit&id=<?= $id ?>" class="btn btn-primary">Modifier</a>
        <a href="/location/public/index.php?url=reservations/start&id=<?= $id ?>" class="btn btn-success"
           onclick="return confirm('Démarrer la location ?')">Démarrer</a>
      <?php elseif ($r['statut'] === 'en cours'): ?>
        <a href="/location/public/index.php?url=reservations/finish&id=<?= $id ?>" class="btn btn-warning">Clôturer</a>
      <?php endif; ?>
      <a href="/location/public/index.php?url=reservations/print&id=<?= $id ?>" class="btn btn-outline-secondary" target="_blank">🖨 Contrat</a>
    </div>
  </div>
    ...
    <div class="col-lg-7">
      ...
      <div class="card mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
          <span>Paiements</span>
          <a href="/location/public/index.php?url=paiements/add&reservation_id=<?= $id ?>" class="btn btn-sm btn-success">+ Enregistrer</a>
        </div>
        <div class="card-body p-0">
          ...
          <table class="table table-hover mb-0">
            <thead class="table-light">
              <tr><th>Date</th><th>Type</th><th>Mode</th><th>Montant</th><th>Réf.</th></tr>
            </thead>
            <tbody>
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-hover mb-0">
            <thead class="table-light">
              <tr><th>Date</th><th>Type</th><th>Statut</th><th>Coût</th></tr>
            </thead>
            <tbody>
    ...
    <div class="col-lg-5">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <a href="/location/public/index.php?url=clients/view&id=<?= $r['client_id'] ?>" class="btn btn-sm btn-outline-primary mt-2">Voir profil client</a>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?php endforeach; ?>
          <?php if (($r['montant_total'] ?? 0) > $totalPaye): ?>
        ...
        <div class="card-footer">
          <a href="/location/public/index.php?url=sinistres/add&reservation_id=<?= $id ?>&vehicle_id=<?= $r['vehicle_id'] ?>&client_id=<?= $r['client_id'] ?>"

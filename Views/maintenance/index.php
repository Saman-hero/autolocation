...
<div class="container-fluid px-4 py-4">
  ...
  <div class="page-header">
    ...
    <a href="/location/public/index.php?url=maintenance/add" class="btn btn-primary">+ Nouvelle maintenance</a>
  </div>
    ...
    <div class="card-body">
      <form method="GET" class="row g-2 align-items-end">
        ...
        <div class="col-auto">
          ...
          <a href="/location/public/index.php?url=maintenance" class="btn btn-outline-secondary btn-sm ms-1">Réinitialiser</a>
        </div>
      </form>
    </div>
  </div>
    ...
    <div class="card-body p-0">
      <?php if (empty($records)): ?>
        <div class="empty-state">
          ...
          <a href="/location/public/index.php?url=maintenance/add" class="btn btn-primary btn-sm">+ Créer la première</a>
        </div>
      <?php else: ?>
        ...
        <table class="table table-hover mb-0">
          ...
          <?php foreach ($records as $r): ?>
            <tr>
              ...
              <td class="text-end">
                <a href="/location/public/index.php?url=maintenance/edit&id=<?= $r['id'] ?>" class="btn btn-sm btn-outline-primary">Modifier</a>
                <a href="/location/public/index.php?url=maintenance/delete&id=<?= $r['id'] ?>"

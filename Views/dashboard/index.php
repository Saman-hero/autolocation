...
<div class="container-fluid px-4 py-4">
  ...
  <div class="alert alert-danger d-flex align-items-center justify-content-between py-2 mb-2 animate-flash">
    ...
    <a href="/location/public/index.php?url=reservations/finish&id=<?= $ret['id'] ?>" class="btn btn-sm btn-danger ms-3">Clôturer</a>
  </div>
  <?php endforeach; ?>
  ...
  <div class="alert <?= $overdue ? 'alert-danger' : 'alert-warning' ?> d-flex align-items-center justify-content-between py-2 mb-2">
    ...
    <a href="/location/public/index.php?url=maintenance/add?vehicle_id=<?= $av['id'] ?>"
    ...
    <div class="col-md-4">
      <div class="card h-100">
        ...
        <div class="card-body d-flex flex-column gap-2 justify-content-center">
          <a href="/location/public/index.php?url=reservations/add" class="btn btn-success py-3">+ Nouvelle location</a>
          <a href="/location/public/index.php?url=clients/add"       class="btn btn-primary py-2">+ Nouveau client</a>
          <a href="/location/public/index.php?url=vehicles/add"      class="btn btn-dark py-2">+ Ajouter véhicule</a>
          <a href="/location/public/index.php?url=reservations" class="btn btn-outline-primary py-2">📅 Calendrier</a>
          <a href="/location/public/index.php?url=paiements/add"     class="btn btn-outline-success py-2">+ Enregistrer paiement</a>
          <?php if (!empty($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
          <a href="/location/public/index.php?url=admin/audit"       class="btn btn-outline-secondary py-2">🔍 Journal d'audit</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body p-0">
          ...
          <div class="empty-state py-3">
            ...
            <p class="small">Aucune activité récente<br><a href="/location/public/index.php?url=dashboard" class="small">Configurer l'audit</a></p>
          </div>
          <?php endif; ?>
        </div>
      </div>
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex gap-2">
        <a href="/location/public/index.php?url=reservations" class="btn btn-sm btn-outline-primary">📅 Calendrier</a>
        <a href="/location/public/index.php?url=reservations" class="btn btn-sm btn-outline-primary">Voir tout</a>
      </div>
    </div>
    <div class="card-body p-0">
      <?php if (empty($recent)): ?>

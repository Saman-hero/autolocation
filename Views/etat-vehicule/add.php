  ...
  <div class="page-header">
    <div>
      <div class="text-muted small mb-1">
        <a href="/location/public/index.php?url=reservations/view&id=<?= $reservationId ?>" class="text-decoration-none text-muted"><?= htmlspecialchars($res['reference']) ?></a> / État véhicule
      </div>
      <h1 class="page-title">
        <?= $type === 'depart' ? '🚗 État au départ' : '🏁 État au retour' ?>
      </h1>
    </div>
    <a href="/location/public/index.php?url=reservations/view&id=<?= $reservationId ?>" class="btn btn-outline-secondary">← Retour</a>
  </div>
    ...
    <div class="card-body">
      <form method="POST" class="row g-4">
        ...
        <div class="col-12 d-flex justify-content-between">
          <a href="/location/public/index.php?url=reservations/view&id=<?= $reservationId ?>" class="btn btn-outline-secondary">Annuler</a>
